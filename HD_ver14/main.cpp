...
int main(int argc, char *argv[]){
	...
	for (;;){
		...
		//tạo đường viền cũng như vẽ các tọa độ điểm 
		...
		if (hg1.mostFrequentFingerNumber >= 4 && hg1.isHand/*handDect(imgClone) && hg1.mostFrequentFingerNumber !=1*/ && flagC == 0){
			flagC = 1;
			MouseLeftBtnDown();
